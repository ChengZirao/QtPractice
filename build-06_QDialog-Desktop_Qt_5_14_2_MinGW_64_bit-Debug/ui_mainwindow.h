...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menuxinjian = new QMenu(menubar);
        menuxinjian->setObjectName(QString::fromUtf8("menuxinjian"));
        ...
        menubar->addAction(menuxinjian->menuAction());
        menubar->addAction(menu->menuAction());
        menuxinjian->addAction(actionNew);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        menuxinjian->setTitle(QCoreApplication::translate("MainWindow", "\346\226\207\344\273\266", nullptr));
